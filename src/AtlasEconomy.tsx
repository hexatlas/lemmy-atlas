...
function AtlasEconomy({ interfaceProps }) {
  const [activeTab, setActiveTab] = useStateStorage("activeEconomyTab", "Introduction");
    ...
    >
      ...
      <Tabs.Content className="tabs-content" value="Introduction">
        <div className="atlas-legend container light">
          <h1>Economy</h1>
          <p>
            This section provides an overview of the economic landscape, including key
            sectors, trade relationships, and economic indicators. It utilizes data from
            reputable sources such as IMF, Comtrade, ILOSTAT, and World Bank to offer
            insights into the economic structures of different countries.
          </p>
          <h2>Instructions</h2>

          <ul className="container dark">
            <li>
              <b>🔗 External Resources:</b> Click to access additional information from
              sources like Comtrade, ILOSTAT, and World Bank.
            </li>
            <li>
          ...
          <blockquote>
            <b>Note:</b> Data availability and accuracy may vary depending on the country
